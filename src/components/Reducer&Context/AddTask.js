...
export  function AddTask(){
    ...
    return(
        <>
        <input value={text} onChange={(e)=>setText(e.target.value)} placeholder='Add tasks'></input>
        <button onClick={() => {setText('');dispatch({type: 'added',id: nextId++,text: text, }); }}>Add</button>
